...
Invoke-WebRequest ("https://raw.githubusercontent.com/technicalandcloud/azure_arc/refs/heads/main/azure_arc_servers_jumpstart/privatelink/artifacts/installArcAgent.ps1") -OutFile C:\Temp\installArcAgent.ps1
